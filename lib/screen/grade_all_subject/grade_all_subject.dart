...
class GradeAllSubjectScreen extends StatefulWidget {
  const GradeAllSubjectScreen(
      {super.key, required this.classId, required this.student});
  final int classId;
  final Student student;

  @override
  State<GradeAllSubjectScreen> createState() => _GradeAllSubjectScreenState();
}

class _GradeAllSubjectScreenState extends State<GradeAllSubjectScreen> {
